...
export function TargetItem({ step, title, description }: TargetItemProps) {
  return (
    <div className="flex w-full items-start gap-5 rounded-lg border border-gray-200 p-6 dark:border-gray-800 md:items-center md:gap-8 md:p-8">
      ...
      <div className="flex flex-col gap-1.5 md:flex-row md:items-center md:gap-6">
        <h3 className="font-title-4 shrink-0 text-gray-950 dark:text-gray-50">{title}</h3>
