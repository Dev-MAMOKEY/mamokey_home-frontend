import { Button } from "@mamokey/ui";

export function ApplyPage() {
  const inputClasses = "font-body-2 w-full rounded-lg border border-gray-200 bg-pure-white p-4 text-gray-950 placeholder:text-gray-400 focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-blue-500 dark:border-gray-800 dark:bg-dark-bg-alt dark:text-gray-50 dark:placeholder:text-gray-600 md:p-5";
    ...
    <div className="flex min-h-screen flex-col bg-pure-white dark:bg-dark-bg">
      ...
      <div className="relative overflow-hidden px-5 pb-16 pt-8 md:pb-20 md:pt-16">
        ...
        <div className="relative mx-auto max-w-170">
          ...
          <h1 className="animate-fade-up font-title-2 text-gray-950 dark:text-gray-50" style={{ animationDelay: "0.1s" }}>14기 아기사자 지원서</h1>
      ...
      <section className="mx-auto flex w-full max-w-170 flex-col gap-14 px-5 pb-20 md:gap-16 md:px-0">
        ...
        <fieldset className="flex flex-col gap-5">
          <legend className="font-title-4 text-gray-950 dark:text-gray-50">지원 파트를 선택해주세요.</legend>
        ...
        {/* 활동 경험 */}
        <fieldset className="flex flex-col gap-5">
          <legend className="font-title-4 text-gray-950 dark:text-gray-50">
            IT 관련 활동 경험이 있으신가요?
          </legend>
          <div className="mt-1 flex flex-col gap-3">
            <label className="font-body-2 flex cursor-pointer items-center gap-3 text-gray-700 dark:text-gray-300">
        ...
        <div className="flex flex-col gap-4">
          <label htmlFor="growth" className="font-title-4 text-gray-950 dark:text-gray-50">
        ...
        {/* 협업 경험 */}
        <div className="flex flex-col gap-4">
          <label htmlFor="collaboration" className="font-title-4 text-gray-950 dark:text-gray-50">
        ...
        {/* 지원 동기 */}
        <div className="flex flex-col gap-4">
          <label htmlFor="motivation" className="font-title-4 text-gray-950 dark:text-gray-50">
        ...
        <div className="flex flex-col gap-6">
          <h3 className="font-title-4 text-gray-950 dark:text-gray-50">개인정보</h3>
        ...
        {/* 개인정보 처리 방침 */}
        <div className="flex flex-col gap-4">
          <h3 className="font-title-4 text-gray-950 dark:text-gray-50">개인정보 처리 방침</h3>
          <div className="font-body-2 max-h-50 overflow-y-auto rounded-lg border border-gray-200 p-4 text-gray-500 dark:border-gray-800 dark:text-gray-500 md:p-5">
            <p>
