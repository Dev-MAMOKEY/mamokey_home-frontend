...
export function Footer({ className }: FooterProps) {
  return (
    <footer className={cn("flex items-end justify-between bg-black px-25 py-20", className)}>
      <div className="flex flex-col gap-5">
        <p className="text-label-1 text-pure-white">
          LIKELION
          <br />
          SHINHAN
        </p>
        <p className="text-label-2 text-white">
          Designed &amp; Developed by MAMOKEY
          <br />
          Privacy Policy &amp; Terms of Use. All rights reserved.
          <br />
          18-35 Mangwol-ro, Uijeongbu-si, Gyeonggi-do
        </p>
      </div>
      <div className="flex flex-col items-end gap-2.5">
        <div className="flex gap-3">
          <a href="https://www.instagram.com/likelion_shinhan" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
